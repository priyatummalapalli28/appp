...
public class Testdoubletap44
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
			...
			w.until(ExpectedConditions.elementToBeClickable(MobileBy.AccessibilityId("doubleTap"))).click();
			...
			try
			{
				w.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[contains(@text,'successful')]")));
