...
public class Test49Multitouchaction

{
	...
	
	{
		...
		try
		{
			...
			ta1.press(ElementOption.element(s1,0,size1.height/2)).waitAction(WaitOptions.waitOptions(Duration.ofSeconds(1))).moveTo(ElementOption.element(s1,size1.width-10,size1.height/2));
			
			TouchAction ta2=new TouchAction(driver);
			ta2.press(ElementOption.element(s2,0,size2.height/2)).waitAction(WaitOptions.waitOptions(Duration.ofSeconds(1))).moveTo(ElementOption.element(s2,size2.width-10,size2.height/2));
